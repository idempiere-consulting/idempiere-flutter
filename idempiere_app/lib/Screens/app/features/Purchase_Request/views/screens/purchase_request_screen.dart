...
// binding
part '../../bindings/purchase_request_binding.dart';

// controller
part '../../controllers/purchase_request_controller.dart';
...
class PurchaseRequestScreen extends GetView<PurchaseRequestController> {
  const PurchaseRequestScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(const PurchaseFilterRequest(), arguments: {
            ...
            SpeedDialChild(
                ...
                onTap: () {
                  Get.toNamed('/PurchaseRequestCreation');
                })
            /* SpeedDialChild(
                label: 'New'.tr,
