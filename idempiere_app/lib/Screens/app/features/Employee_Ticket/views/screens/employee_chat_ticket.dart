...
class HumanResourceChat extends StatefulWidget {
  const HumanResourceChat({Key? key}) : super(key: key);

  @override
  State<HumanResourceChat> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<HumanResourceChat> {
  ...
  Future<void> _handleSendPressed(types.PartialText message) async {
    ...
    var url = Uri.parse(
        '$protocol://$ip/api/v1/windows/request-all/${Get.arguments["ticketid"]}');
