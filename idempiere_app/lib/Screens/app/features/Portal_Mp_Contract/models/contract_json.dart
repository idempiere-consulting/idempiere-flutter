class ContractJSON {
  ...
  ContractJSON.fromJson(Map<String, dynamic> json)
...
class Records {
  ...
  Records.fromJson(Map<String, dynamic> json)
    : id = json['id'] as int?,
      ...
      contractTypeID = json['ContractType_ID'] as String?,
      validtodate = json['validtodate'] as String?,
      validfromdate = json['validfromdate'] as String?,
      validnexttodate = json['validnexttodate'] as String?,
      ...
      cBPartnerVendorID = (json['C_BPartner_Vendor_ID'] as Map<String,dynamic>?) != null ? CBPartnerVendorID.fromJson(json['C_BPartner_Vendor_ID'] as Map<String,dynamic>) : null,
  ...
  Map<String, dynamic> toJson() => {
    ...
    'validnexttodate' : validnexttodate,
