...
import 'package:idempiere_app/Screens/app/features/Portal_Mp_Contract/models/contract_json.dart';
                  ...
                  children: [
                    Container(
                      child: Obx(() => controller.dataAvailable
                          ? Text("CONTRACTS: ".tr + controller.trx.rowcount.toString())
                          : Text("CONTRACTS: ".tr)),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Visibility(
                                                visible: controller
                                                        .trx
                                                        .records![index].cDocTypeTargetID!.identifier !=
                                                    '',
                                ...
                                child: Container(
                                  ...
                                  child: ExpansionTile(
                                    trailing: IconButton(
                                      icon: Icon(
                                        Icons.article,
                                        color: controller.trx.records![index].documentNo ==
                                                "CO"
                                            ? Colors.green
                                            : Colors.yellow,
                                      ),
