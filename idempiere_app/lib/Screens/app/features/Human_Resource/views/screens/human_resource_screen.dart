...
// controller
part '../../controllers/human_resource_controller.dart';
...
class HumanResourceScreen extends GetView<HumanResourceController> {
  const HumanResourceScreen({Key? key}) : super(key: key);
