...
class CreateTrainingCourseScore extends StatefulWidget {
  const CreateTrainingCourseScore({Key? key}) : super(key: key);

  @override
  State<CreateTrainingCourseScore> createState() =>
      _CreateTrainingCourseScoreState();
}

class _CreateTrainingCourseScoreState extends State<CreateTrainingCourseScore> {
  createLead() async {
