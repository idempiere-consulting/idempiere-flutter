...
class EditTrainingCourseScore extends StatefulWidget {
  const EditTrainingCourseScore({Key? key}) : super(key: key);

  @override
  State<EditTrainingCourseScore> createState() =>
      _EditTrainingCourseScoreState();
}

class _EditTrainingCourseScoreState extends State<EditTrainingCourseScore> {
  editLead() async {
