...
class BPRecords {
  ...
  BPRecords.fromJson(Map<String, dynamic> json) {
    ...
    sOCreditUsed = json['SO_CreditUsed'] as int?;
    ...
    actualLifeTimeValue = json['ActualLifeTimeValue'] as int?;
    ...
    totalOpenBalance = json['TotalOpenBalance'] as int?;
