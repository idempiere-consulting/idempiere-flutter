...
class CreateOpportunityTasks extends StatefulWidget {
  const CreateOpportunityTasks({Key? key}) : super(key: key);

  @override
  State<CreateOpportunityTasks> createState() => _CreateOpportunityTasksState();
}

class _CreateOpportunityTasksState extends State<CreateOpportunityTasks> {
  createEvent() async {
    ...
    var msg = {
      ...
      "IsOpenToDoJP": true,
      "JP_ToDo_Type": {"id": "S"},
      "C_Opportunity_ID": {"id": opportunityId},
  ...
  int opportunityId = 0;
  // ignore: prefer_typing_uninitialized_variables
  var opportunityFieldController;
  //var adUserId;
  ...
  void initState() {
    ...
    opportunityFieldController =
        TextEditingController(text: args["opportunityName"] ?? "");
    opportunityId = args["opportunityId"] ?? 0;
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    minLines: 1,
                    maxLines: 4,
                    controller: opportunityFieldController,
                    decoration: InputDecoration(
                      prefixIcon: const Icon(Icons.person_outlined),
                      border: const OutlineInputBorder(),
                      labelText: 'Opportunity'.tr,
