...
// binding
part '../../bindings/ticket_ticket_binding.dart';

// controller
part '../../controllers/ticket_ticket_controller.dart';
...
class TicketTicketScreen extends GetView<TicketTicketController> {
  const TicketTicketScreen({Key? key}) : super(key: key);
