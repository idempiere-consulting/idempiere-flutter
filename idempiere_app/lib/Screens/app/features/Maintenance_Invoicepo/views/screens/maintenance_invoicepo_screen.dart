...
// binding
part '../../bindings/maintenance_invoicepo_binding.dart';

// controller
part '../../controllers/maintenance_invoicepo_controller.dart';
...
class MaintenanceInvoicepoScreen extends GetView<MaintenanceInvoicepoController> {
  const MaintenanceInvoicepoScreen({Key? key}) : super(key: key);
