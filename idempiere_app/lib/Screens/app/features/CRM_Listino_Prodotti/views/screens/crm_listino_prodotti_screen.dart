...
// binding
part '../../bindings/crm_listino_prodotti_binding.dart';

// controller
part '../../controllers/crm_listino_prodotti_controller.dart';
...
class CRMListinoProdottiScreen extends GetView<CRMListinoProdottiController> {
  const CRMListinoProdottiScreen({Key? key}) : super(key: key);
