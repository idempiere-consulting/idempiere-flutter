...
class CRMPriceListController extends GetxController {
  ...
  Future<void> getPriceList() async {
    ...
    var url = Uri.parse(
        '$protocol://$ip/api/v1/models/lit_pricelist_v?\$filter= M_PriceList_ID eq ${priceListId.value} and C_BPartner_ID eq $businessPartnerId and AD_Client_ID eq ${GetStorage().read("clientid")}$valueFilter$nameFilter$descriptionFilter&\$skip=${(pagesCount.value - 1) * 100}');
