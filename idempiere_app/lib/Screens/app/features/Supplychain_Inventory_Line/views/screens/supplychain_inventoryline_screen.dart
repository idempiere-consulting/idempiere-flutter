...
// binding
part '../../bindings/supplychain_inventoryline_binding.dart';

// controller
part '../../controllers/supplychain_inventoryline_controller.dart';
...
class SupplychainInventoryLineScreen
    extends GetView<SupplychainInventoryLineController> {
  const SupplychainInventoryLineScreen({Key? key}) : super(key: key);
