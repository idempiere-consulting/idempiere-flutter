...
class Records {
  ...
  final bool? lITIsBOMExplNotDescription;
  ...
  Records({
    ...
    this.lITIsBOMExplNotDescription,
    this.modelname,
  });
  ...
  Records.fromJson(Map<String, dynamic> json)
    : id = json['id'] as int?,
      ...
      lITIsBOMExplNotDescription = json['LIT_IsBOMExplNotDescription'] as bool?,
  ...
  Map<String, dynamic> toJson() => {
    ...
    'LIT_IsBOMExplNotDescription' : lITIsBOMExplNotDescription,
