...
// binding
part '../../bindings/vehicle_equipment_vehicle_binding.dart';

// controller
part '../../controllers/vehicle_equipment_vehicle_controller.dart';
...
class VehicleEquipmentVehicleScreen
    extends GetView<VehicleEquipmentVehicleController> {
  const VehicleEquipmentVehicleScreen({Key? key}) : super(key: key);
