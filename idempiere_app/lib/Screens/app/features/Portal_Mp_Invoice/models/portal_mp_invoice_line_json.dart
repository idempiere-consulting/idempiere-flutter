class PortalMPInvoiceLineJson {
  ...
  PortalMPInvoiceLineJson.fromJson(Map<String, dynamic> json)
...
class Records {
  ...
  Records.fromJson(Map<String, dynamic> json)
    : id = json['id'] as int?,
      ...
      cInvoiceID = (json['C_Invoice_ID'] as Map<String,dynamic>?) != null ? CInvoiceID.fromJson(json['C_Invoice_ID'] as Map<String,dynamic>) : null,
      ...
      cActivityID = (json['C_Activity_ID'] as Map<String,dynamic>?) != null ? CActivityID.fromJson(json['C_Activity_ID'] as Map<String,dynamic>) : null,
