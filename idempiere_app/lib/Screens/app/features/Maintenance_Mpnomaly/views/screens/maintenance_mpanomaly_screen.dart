...
import 'package:idempiere_app/Screens/app/features/Maintenance_Mpnomaly/views/screens/maintenance_edit_anomaly.dart';
...
// binding
part '../../bindings/maintenance_mpanomaly_binding.dart';

// controller
part '../../controllers/maintenance_mpanomaly_controller.dart';
...
class MaintenanceMpanomalyScreen
    extends GetView<MaintenanceMpanomalyController> {
  const MaintenanceMpanomalyScreen({Key? key}) : super(key: key);
                                ...
                                child: ExpansionTile(
                                  ...
                                  leading: Container(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        Get.to(const MaintenanceEditAnomaly(),
                                            arguments: {
                                              "MPOTName": controller
                                                  .trx
                                                  .records![index]
                                              ...
                                              "isManagedByCustomer": controller
                                                  .trx
                                                  .records![index]
                                                  .lITIsManagedByCustomer,
                                              "isClosed": controller
                                                  .trx.records![index].isClosed,
                                            });
                                  ...
                                  title: Text(
                                    controller.trx.records![index].mpotid
                                            ?.identifier ??
                                        "???",
