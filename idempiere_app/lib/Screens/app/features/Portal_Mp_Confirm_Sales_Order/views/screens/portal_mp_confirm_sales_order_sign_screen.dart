...
class PortalMPConfirmOrderSignatureScreen extends StatefulWidget {
  const PortalMPConfirmOrderSignatureScreen({Key? key}) : super(key: key);

  @override
  PortalMPConfirmOrderSignatureScreenState createState() =>
      PortalMPConfirmOrderSignatureScreenState();
}

class PortalMPConfirmOrderSignatureScreenState
    extends State<PortalMPConfirmOrderSignatureScreen> {
          ...
          Padding(
            ...
            child: IconButton(
              onPressed: () async {
                ...
                Get.find<PortalMpConfirmSalesOrderController>().imageInt =
                    (await _controller.toPngBytes())!;
                Get.find<PortalMpConfirmSalesOrderController>().image64.value =
                    base64.encode(data!);
                Get.back();
