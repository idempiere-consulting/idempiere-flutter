...
// binding
part '../../bindings/portal_mp_invoicepo_binding.dart';

// controller
part '../../controllers/portal_mp_invoicepo_controller.dart';
...
class PortalMpInvoicepoScreen extends GetView<PortalMpInvoicepoController> {
  const PortalMpInvoicepoScreen({Key? key}) : super(key: key);
