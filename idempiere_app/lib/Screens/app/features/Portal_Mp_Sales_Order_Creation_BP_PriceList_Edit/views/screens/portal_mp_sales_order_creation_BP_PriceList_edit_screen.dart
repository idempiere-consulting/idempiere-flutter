...
// binding
part '../../bindings/portal_mp_sales_order_creation_BP_PriceList_edit_binding.dart';

// controller
part '../../controllers/portal_mp_sales_order_creation_BP_PriceList_edit_controller.dart';
...
class PortalMpSalesOrderCreationBPPriceListEditScreen
    extends GetView<PortalMpSalesOrderCreationBPPriceListEditController> {
  const PortalMpSalesOrderCreationBPPriceListEditScreen({Key? key})
      : super(key: key);
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        if (double.tryParse(value) !=
                                                                          ...
                                                                          controller
                                                                              .qtyFieldController
                                                                              .text = (double.parse(controller.qtyMinFieldController.text) *
                                                                                  double.parse(controller.qtyMultiplierController.text))
                                                                              .toStringAsFixed(2);
                                                                        } else {
                                                                        ...
                                                                        if (double.tryParse(value) !=
                                                                          ...
                                                                          controller
                                                                              ...
                                                                              .text = (double.parse(value) -
                                                                                  ((double.parse(value) / 100) * double.parse(controller.discountFieldController.text)))
                                                                              .toStringAsFixed(2);
                                                                          controller
                                                                              .totalRowPriceFieldController
                                                                              .text = (double.parse(controller.qtyFieldController.text) *
