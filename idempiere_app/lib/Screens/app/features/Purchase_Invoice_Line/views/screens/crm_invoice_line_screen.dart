...
// binding
part '../../bindings/crm_invoice_line_binding.dart';

// controller
part '../../controllers/crm_invoice_line_controller.dart';
...
class CRMInvoicePOLineScreen extends GetView<CRMInvoicePOLineController> {
  const CRMInvoicePOLineScreen({Key? key}) : super(key: key);
