...
class CRMInvoicePOLineController extends GetxController {
  //final scaffoldKey = GlobalKey<ScaffoldState>();
  late InvoiceLineJson _trx;
  ...
  Future<void> getInvoices() async {
    ...
    var url = Uri.parse(
        '$protocol://$ip/api/v1/models/c_invoiceline?\$filter= C_Invoice_ID eq ${Get.arguments["id"]} and AD_Client_ID eq ${GetStorage().read("clientid")}');
