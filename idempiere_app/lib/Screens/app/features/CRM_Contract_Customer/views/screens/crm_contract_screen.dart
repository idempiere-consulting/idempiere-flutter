...
import 'package:idempiere_app/Screens/app/features/CRM_Contract_Customer/views/screens/crm_contract_filter_screen.dart';
import 'package:idempiere_app/Screens/app/features/CRM_Contract_Customer/views/screens/crm_edit_contract.dart';
...
class CRMContractCustomerScreen extends GetView<CRMContractCustomerController> {
  const CRMContractCustomerScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(const CRMFilterContractCustomer(), arguments: {
                                  ...
                                  child: Container(
                                    ...
                                    child: ExpansionTile(
                                      trailing: IconButton(
                                        ...
                                        onPressed: () {
                                          Get.toNamed('/ContractCustomerLine',
                                              arguments: {
                                                "id": controller
