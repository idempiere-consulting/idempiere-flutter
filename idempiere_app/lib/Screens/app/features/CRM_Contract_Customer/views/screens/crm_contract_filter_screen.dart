...
class CRMFilterContractCustomer extends StatefulWidget {
  const CRMFilterContractCustomer({Key? key}) : super(key: key);

  @override
  State<CRMFilterContractCustomer> createState() =>
      _CRMFilterContractCustomerState();
}

class _CRMFilterContractCustomerState extends State<CRMFilterContractCustomer> {
  applyFilters() {
    if (businessPartnerId > 0) {
      Get.find<CRMContractCustomerController>().businessPartnerFilter =
    ...
    if (docNoFieldController.text != "") {
      Get.find<CRMContractCustomerController>().docNoFilter =
    ...
    if (docTypeId != "0") {
      Get.find<CRMContractCustomerController>().docTypeFilter =
          " and C_DocTypeTarget_ID eq $docTypeId";
    } else {
      Get.find<CRMContractCustomerController>().docTypeFilter = "";
    }

    Get.find<CRMContractCustomerController>().businessPartnerId.value =
        businessPartnerId;

    if (businessPartnerId > 0) {
      Get.find<CRMContractCustomerController>().businessPartnerName =
          bpSearchFieldController.text;
    } else {
      Get.find<CRMContractCustomerController>().businessPartnerName = "";
    }
    Get.find<CRMContractCustomerController>().docNoValue.value =
        docNoFieldController.text;
    Get.find<CRMContractCustomerController>().docTypeId.value = docTypeId;
