...
class PortalMPFilterCourseList extends StatefulWidget {
  const PortalMPFilterCourseList({Key? key}) : super(key: key);

  @override
  State<PortalMPFilterCourseList> createState() =>
      _PortalMPFilterCourseListState();
}

class _PortalMPFilterCourseListState extends State<PortalMPFilterCourseList> {
  applyFilters() {
