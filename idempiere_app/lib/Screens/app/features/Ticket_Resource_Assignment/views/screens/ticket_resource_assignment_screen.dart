...
// binding
part '../../bindings/ticket_resource_assignment_binding.dart';

// controller
part '../../controllers/ticket_resource_assignment_controller.dart';
...
class TicketResourceAssignmentScreen
    extends GetView<TicketResourceAssignmentController> {
  const TicketResourceAssignmentScreen({Key? key}) : super(key: key);
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      onPressed: () {
                        controller.getResourceAssignments();
                      },
                      icon: const Icon(
                        Icons.refresh,
                        color: Colors.yellow,
