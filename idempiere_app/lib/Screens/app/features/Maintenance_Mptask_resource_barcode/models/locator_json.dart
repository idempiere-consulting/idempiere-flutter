class LocatorJson {
  ...
  LocatorJson.fromJson(Map<String, dynamic> json)
      : pagecount = json['page-count'] as int?,
        recordssize = json['records-size'] as int?,
        skiprecords = json['skip-records'] as int?,
        rowcount = json['row-count'] as int?,
        records = (json['records'] as List?)
            ?.map((dynamic e) => LRecords.fromJson(e as Map<String, dynamic>))
            .toList();
...
class LRecords {
  ...
  LRecords.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int?,
