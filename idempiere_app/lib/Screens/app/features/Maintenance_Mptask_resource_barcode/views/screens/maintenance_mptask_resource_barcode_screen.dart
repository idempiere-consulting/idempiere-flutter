...
// binding
part '../../bindings/maintenance_mptask_resource_barcode_binding.dart';

// controller
part '../../controllers/maintenance_mptask_resource_barcode_controller.dart';
...
class MaintenanceMpResourceBarcodeScreen
    extends GetView<MaintenanceMpResourceBarcodeController> {
  const MaintenanceMpResourceBarcodeScreen({Key? key}) : super(key: key);
