...
// binding
part '../../bindings/ticket_task_binding.dart';

// controller
part '../../controllers/ticket_task_controller.dart';
...
class TicketTaskScreen extends GetView<TicketTaskController> {
  const TicketTaskScreen({Key? key}) : super(key: key);
