...
class TicketInternalChat extends StatefulWidget {
  const TicketInternalChat({Key? key}) : super(key: key);

  @override
  State<TicketInternalChat> createState() => TicketInternalChatState();
}

class TicketInternalChatState extends State<TicketInternalChat> {
