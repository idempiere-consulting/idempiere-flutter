...
// binding
part '../../bindings/crm_contatti_bp_binding.dart';

// controller
part '../../controllers/crm_contatti_bp_controller.dart';
...
class CRMContattiBPScreen extends GetView<CRMContattiBPController> {
  const CRMContattiBPScreen({Key? key}) : super(key: key);
