...
// binding
part '../../bindings/ticketclient_binding.dart';

// controller
part '../../controllers/ticketclient_controller.dart';
...
class TicketClientScreen extends GetView<TicketClientController> {
  const TicketClientScreen({Key? key}) : super(key: key);
