...
import 'package:idempiere_app/Screens/app/features/CRM_Purchase_Order_Line/views/screens/crm_create_sales_orderline.dart';
import 'package:idempiere_app/Screens/app/features/CRM_Purchase_Order_Line/views/screens/crm_edit_sales_orderline.dart';
...
class CRMPurchaseOrderLineScreen
    extends GetView<CRMPurchaseOrderLineController> {
  const CRMPurchaseOrderLineScreen({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: IconButton(
                onPressed: () {
                  ...
                  Get.to(const CreatePurchaseOrderLine(), arguments: {
                    "id": Get.arguments["id"],
