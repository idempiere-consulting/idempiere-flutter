...
import 'package:idempiere_app/Screens/app/features/CRM_Invoice_PO/views/screens/crm_edit_invoice.dart';
import 'package:idempiere_app/Screens/app/features/CRM_Invoice_PO/views/screens/crm_invoice_filter_screen.dart';
...
// controller
part '../../controllers/crm_invoice_controller.dart';
...
class CRMInvoicePOScreen extends GetView<CRMInvoicePOController> {
  const CRMInvoicePOScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(const CRMFilterInvoicePO(), arguments: {
