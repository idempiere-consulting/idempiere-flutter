...
// binding
part '../../bindings/maintenance_shipment_binding.dart';

// controller
part '../../controllers/maintenance_shipment_controller.dart';
...
class MaintenanceShipmentScreen extends GetView<MaintenanceShipmentController> {
  const MaintenanceShipmentScreen({Key? key}) : super(key: key);
