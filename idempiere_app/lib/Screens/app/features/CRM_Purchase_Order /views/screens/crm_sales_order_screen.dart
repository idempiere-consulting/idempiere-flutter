...
import 'package:idempiere_app/Screens/app/features/CRM_Purchase_Order%20/views/screens/crm_edit_sales_order.dart';
import 'package:idempiere_app/Screens/app/features/CRM_Purchase_Order%20/views/screens/crm_sales_order_filter_screen.dart';
...
class CRMPurchaseOrderScreen extends GetView<CRMPurchaseOrderController> {
  const CRMPurchaseOrderScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(const CRMFilterPurchaseOrder(), arguments: {
