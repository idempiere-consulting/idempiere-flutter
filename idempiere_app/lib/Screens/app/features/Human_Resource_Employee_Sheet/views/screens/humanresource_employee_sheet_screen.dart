...
// binding
part '../../bindings/humanresource_employee_sheet_binding.dart';

// controller
part '../../controllers/humanresource_employee_sheet_controller.dart';
...
class HumanResourceEmployeeSheetScreen
    extends GetView<HumanResourceEmployeeSheetController> {
  const HumanResourceEmployeeSheetScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(() => const HumanResourceFilterEmployeeSheet(),
                      arguments: {
