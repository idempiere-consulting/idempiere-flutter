...
// binding
part '../../bindings/supplychain_binding.dart';

// controller
part '../../controllers/supplychain_controller.dart';
...
class SupplychainScreen extends GetView<SupplychainController> {
  const SupplychainScreen({Key? key}) : super(key: key);
