...
class EditMaintainCardRow extends StatefulWidget {
  final Function getMaintainCardLines;
  const EditMaintainCardRow({Key? key, required this.getMaintainCardLines})
      : super(key: key);

  @override
  State<EditMaintainCardRow> createState() => _EditMaintainCardRowState();
}

class _EditMaintainCardRowState extends State<EditMaintainCardRow> {
  editMaintainCardRow() async {
  ...
  void initState() {
    super.initState();
    lineNoFieldController =
        TextEditingController(text: args['lineNo'].toString());
    productName = TextEditingController(text: args['productName']);
    productId = args['productId'];
    qtyBOM = TextEditingController(text: args['qtyBOM'].toString());
    nameFieldController = TextEditingController(text: args['name']);
    descriptionFieldController =
        TextEditingController(text: args['description']);
    productToName = TextEditingController(text: args['productToName']);
    productToId = args['productToId'];
