...
// binding
part '../../bindings/dashboard_assetresource_binding.dart';

// controller
part '../../controllers/dashboard_assetresource_controller.dart';
...
class DashboardAssetresourceScreen
    extends GetView<DashboardAssetresourceController> {
  const DashboardAssetresourceScreen({Key? key}) : super(key: key);
