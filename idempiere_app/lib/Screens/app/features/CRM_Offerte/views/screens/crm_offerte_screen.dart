...
// binding
part '../../bindings/crm_offerte_binding.dart';

// controller
part '../../controllers/crm_offerte_controller.dart';
...
class CRMOfferteScreen extends GetView<CRMOfferteController> {
  const CRMOfferteScreen({Key? key}) : super(key: key);
