...
class PortalMpEditOpportunity extends StatefulWidget {
  const PortalMpEditOpportunity({Key? key}) : super(key: key);

  @override
  State<PortalMpEditOpportunity> createState() =>
      _PortalMpEditOpportunityState();
}

class _PortalMpEditOpportunityState extends State<PortalMpEditOpportunity> {
