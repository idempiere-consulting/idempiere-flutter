...
import 'package:idempiere_app/Screens/app/features/Supplychain_Product_List/views/screens/supplychain_product_list_filter_screen.dart';
...
// controller
part '../../controllers/supplychain_product_list_controller.dart';
...
class SupplychainProductListScreen
    extends GetView<SupplychainProductListController> {
  const SupplychainProductListScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(const SupplychainFilterProductList(), arguments: {
