...
class SupplychainFilterProductList extends StatefulWidget {
  const SupplychainFilterProductList({Key? key}) : super(key: key);

  @override
  State<SupplychainFilterProductList> createState() =>
      _SupplychainFilterProductListState();
}

class _SupplychainFilterProductListState
    extends State<SupplychainFilterProductList> {
  applyFilters() {
    if (valueFieldController.text != "") {
      Get.find<SupplychainProductListController>().valueFilter =
    ...
    if (nameFieldController.text != "") {
      Get.find<SupplychainProductListController>().nameFilter =
    ...
    if (descriptionFieldController.text != "") {
      Get.find<SupplychainProductListController>().descriptionFilter =
          " and contains(tolower(Description),'${descriptionFieldController.text}')";
    } else {
      Get.find<SupplychainProductListController>().descriptionFilter = "";
    }

    Get.find<SupplychainProductListController>().value.value =
        valueFieldController.text;
    Get.find<SupplychainProductListController>().name.value =
        nameFieldController.text;
    Get.find<SupplychainProductListController>().description.value =
        descriptionFieldController.text;

    Get.find<SupplychainProductListController>().getProductLists();
    Get.back();
  }
