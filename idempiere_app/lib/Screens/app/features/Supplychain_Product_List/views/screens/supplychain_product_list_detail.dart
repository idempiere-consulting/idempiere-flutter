...
class SupplychainProductListDetail extends StatefulWidget {
  const SupplychainProductListDetail({Key? key}) : super(key: key);

  @override
  State<SupplychainProductListDetail> createState() =>
      _SupplychainProductListDetailState();
}

class _SupplychainProductListDetailState
    extends State<SupplychainProductListDetail> with TickerProviderStateMixin {
