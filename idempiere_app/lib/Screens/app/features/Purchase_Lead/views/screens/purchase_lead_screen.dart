...
import 'package:idempiere_app/Screens/app/features/Purchase_Lead/views/screens/purchase_create_leads.dart';
import 'package:idempiere_app/Screens/app/features/Purchase_Lead/views/screens/purchase_edit_leads.dart';
import 'package:idempiere_app/Screens/app/features/Purchase_Lead/views/screens/purchase_lead_filter_screen.dart';
...
// binding
part '../../bindings/purchase_lead_binding.dart';

// controller
part '../../controllers/purchase_lead_controller.dart';
...
class PurchaseLeadScreen extends GetView<PurchaseLeadController> {
  const PurchaseLeadScreen({Key? key}) : super(key: key);
                          ...
                          child: Row(
                            children: [
                              ...
                              Obx(() => controller.dataAvailable
                                  ? Text(
                                      "${"PURCHASE LEAD".tr}: ${controller.trx.rowcount}")
                                  : Text("${"PURCHASE LEAD".tr}: ")),
                            ],
                          ),
                        ),
                      ),
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(() => const PurchaseFilterLead(), arguments: {
            ...
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(() => const CreatePurchaseLead());
                })
          ],
        ),
