...
// binding
part '../../bindings/maintenance_mppicking_binding.dart';

// controller
part '../../controllers/maintenance_mppicking.dart';
...
class MaintenanceMppickingScreen
    extends GetView<MaintenanceMppickingController> {
  const MaintenanceMppickingScreen({Key? key}) : super(key: key);
