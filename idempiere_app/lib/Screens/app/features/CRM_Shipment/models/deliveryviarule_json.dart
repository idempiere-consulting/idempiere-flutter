class DeliveryViaRuleJSON {
  final int? pagecount;
  final int? recordssize;
  final int? skiprecords;
  final int? rowcount;
  final int? arraycount;
  final List<DVRRecords>? records;
  ...
  DeliveryViaRuleJSON.fromJson(Map<String, dynamic> json)
      : pagecount = json['page-count'] as int?,
        ...
        records = (json['records'] as List?)
            ?.map((dynamic e) => DVRRecords.fromJson(e as Map<String, dynamic>))
            .toList();
...
class DVRRecords {
  ...
  DVRRecords.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int?,
