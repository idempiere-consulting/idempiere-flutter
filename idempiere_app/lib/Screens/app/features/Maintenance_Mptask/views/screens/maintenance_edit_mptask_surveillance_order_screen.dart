...
class MaintenanceEditMptaskSurveillanceOrder extends StatefulWidget {
  const MaintenanceEditMptaskSurveillanceOrder(
      {Key? key, required this.getWorkorderResources})
      : super(key: key);

  final Function() getWorkorderResources;

  @override
  State<MaintenanceEditMptaskSurveillanceOrder> createState() =>
      _MaintenanceEditMptaskSurveillanceOrderState();
}

class _MaintenanceEditMptaskSurveillanceOrderState
    extends State<MaintenanceEditMptaskSurveillanceOrder> {
