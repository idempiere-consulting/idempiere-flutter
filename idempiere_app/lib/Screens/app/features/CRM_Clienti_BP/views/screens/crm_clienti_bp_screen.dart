...
// binding
part '../../bindings/crm_clienti_bp_binding.dart';
...
class CRMClientiBPScreen extends GetView<CRMClientiBPController> {
  const CRMClientiBPScreen({Key? key}) : super(key: key);
