...
class CreateTrainingCourse extends StatefulWidget {
  const CreateTrainingCourse({Key? key}) : super(key: key);

  @override
  State<CreateTrainingCourse> createState() => _CreateTrainingCourseState();
}

class _CreateTrainingCourseState extends State<CreateTrainingCourse> {
  createLead() async {
