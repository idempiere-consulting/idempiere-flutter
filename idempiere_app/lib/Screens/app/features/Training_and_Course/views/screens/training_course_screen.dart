...
// controller
part '../../controllers/training_course_controller.dart';
...
class TrainingCourseScreen extends GetView<TrainingCourseController> {
  const TrainingCourseScreen({Key? key}) : super(key: key);
