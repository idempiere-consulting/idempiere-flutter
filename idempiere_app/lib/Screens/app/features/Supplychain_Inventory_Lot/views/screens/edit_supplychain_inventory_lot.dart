...
class EditSupplychainInventoryLot extends StatefulWidget {
  const EditSupplychainInventoryLot({Key? key}) : super(key: key);

  @override
  State<EditSupplychainInventoryLot> createState() =>
      _EditSupplychainInventoryLotState();
}

class _EditSupplychainInventoryLotState
