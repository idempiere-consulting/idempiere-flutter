class ParticipantJSON {
  ...
  ParticipantJSON.fromJson(Map<String, dynamic> json)
...
class Records {
  ...
  Records.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int?,
        ...
        decimalPoint = json['DecimalPoint'] as int?,
        openAnswersLeft = json['open_answers_left'] as String?,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'open_answers_left': openAnswersLeft,
