...
// binding
part '../../bindings/maintenance_tbd_binding.dart';

// controller
part '../../controllers/maintenance_tbd_controller.dart';
...
class MaintenanceTbdScreen extends GetView<MaintenanceTbdController> {
  const MaintenanceTbdScreen({Key? key}) : super(key: key);
