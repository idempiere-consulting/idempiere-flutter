...
import 'package:idempiere_app/Screens/app/features/Portal_Mp_Anomaly/models/anomaly_json.dart';
                  ...
                  children: [
                    Container(
                      child: Obx(() => controller.dataAvailable
                          ? Text("ANOMALIES: ".tr + controller.trx.rowcount.toString())
                          : Text("ANOMALIES: ".tr)),
                            ...
                            return Obx (() => Visibility(
                              visible: controller.searchFilterValue.value ==
                                    ...
                                    : controller.dropdownValue.value == "1"
                                        ? controller.trx.records![index].description
                                            .toString()
                                            .toLowerCase()
                                            .contains(controller
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                  controller.trx.records![index].cbPartnerID?.identifier != null ?  
                                                  "Busines Partner: ".tr + controller.trx.records![index].cbPartnerID!.identifier.toString() :
                                                  "",
                                          )],
                                          ),
                                        ],
