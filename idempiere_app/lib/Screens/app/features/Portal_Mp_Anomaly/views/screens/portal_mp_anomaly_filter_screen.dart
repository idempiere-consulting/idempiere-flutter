...
class PortalMPFilterAnomaly extends StatefulWidget {
  const PortalMPFilterAnomaly({Key? key}) : super(key: key);

  @override
  State<PortalMPFilterAnomaly> createState() => _PortalMPFilterAnomalyState();
}

class _PortalMPFilterAnomalyState extends State<PortalMPFilterAnomaly> {
  applyFilters() {
