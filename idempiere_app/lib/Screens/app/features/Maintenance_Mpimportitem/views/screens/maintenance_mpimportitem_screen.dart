...
// binding
part '../../bindings/maintenance_mpimportitem_binding.dart';

// controller
part '../../controllers/maintenance_mpimportitem_controller.dart';
...
class MaintenanceMpimportitemScreen
    extends GetView<MaintenanceMpimportitemController> {
  const MaintenanceMpimportitemScreen({Key? key}) : super(key: key);
