...
class PurchaseContractScreen extends GetView<PurchaseContractController> {
  const PurchaseContractScreen({Key? key}) : super(key: key);
        ...
        childrenButtonSize: const Size(45, 45), */
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Get.to(const PurchaseFilterContract(), arguments: {
                                      ...
                                      leading: Container(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            Get.to(const PurchaseEditContract(),
                                                arguments: {
                                                  "id": controller
                                                      .trx.records![index].id,
                                                  "name": controller
