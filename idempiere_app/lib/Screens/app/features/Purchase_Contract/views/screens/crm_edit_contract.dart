...
class PurchaseEditContract extends StatefulWidget {
  const PurchaseEditContract({Key? key}) : super(key: key);

  @override
  State<PurchaseEditContract> createState() => _PurchaseEditContractState();
}

class _PurchaseEditContractState extends State<PurchaseEditContract> {
  editContract() async {
