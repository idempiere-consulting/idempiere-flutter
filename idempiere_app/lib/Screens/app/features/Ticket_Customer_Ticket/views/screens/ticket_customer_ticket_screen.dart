...
// binding
part '../../bindings/ticket_customer_ticket_binding.dart';

// controller
part '../../controllers/ticket_customer_ticket_controller.dart';
...
class TicketCustomerTicketScreen
    extends GetView<TicketCustomerTicketController> {
  const TicketCustomerTicketScreen({Key? key}) : super(key: key);
