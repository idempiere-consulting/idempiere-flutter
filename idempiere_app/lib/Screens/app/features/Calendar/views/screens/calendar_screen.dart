      ...
      if (selectedEvents[
        ...
        selectedEvents[
          ...
          Event(
            ...
            projectId: list[i].cProjectID?.id,
            projectName: list[i].cProjectID?.identifier,
            businessPartnerId: list[i].cBPartnerID?.id,
            businessPartnername: list[i].cBPartnerID?.identifier,
          ),
        );
      } else {
        selectedEvents[
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          Get.off(const EditCalendarEvent(), arguments: {
                            ...
                            "businessPartnerID": event.businessPartnerId,
                            "businessPartnerName": event.businessPartnername,
                          });
                        },
                      ),
                    ),
