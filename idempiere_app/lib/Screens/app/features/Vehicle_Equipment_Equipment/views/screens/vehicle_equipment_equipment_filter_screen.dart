...
class VehicleEquipmentFilterEquipment extends StatefulWidget {
  const VehicleEquipmentFilterEquipment({Key? key}) : super(key: key);

  @override
  State<VehicleEquipmentFilterEquipment> createState() =>
      _VehicleEquipmentFilterEquipmentState();
}

class _VehicleEquipmentFilterEquipmentState
    extends State<VehicleEquipmentFilterEquipment> {
  applyFilters() {
    if (valueFieldController.text != "") {
      Get.find<VehicleEquipmentEquipmentController>().valueFilter =
    ...
    if (nameFieldController.text != "") {
      Get.find<VehicleEquipmentEquipmentController>().nameFilter =
    ...
    if (licensePlateFieldController.text != "") {
      Get.find<VehicleEquipmentEquipmentController>().licensePlateFilter =
          " and contains(tolower(LIT_LicensePlate),'${licensePlateFieldController.text}')";
    } else {
      Get.find<VehicleEquipmentEquipmentController>().licensePlateFilter = "";
    }

    Get.find<VehicleEquipmentEquipmentController>().value.value =
        valueFieldController.text;
    Get.find<VehicleEquipmentEquipmentController>().name.value =
        nameFieldController.text;
    Get.find<VehicleEquipmentEquipmentController>().licensePlate.value =
        licensePlateFieldController.text;

    Get.find<VehicleEquipmentEquipmentController>().getEquipment();
    Get.back();
  }
