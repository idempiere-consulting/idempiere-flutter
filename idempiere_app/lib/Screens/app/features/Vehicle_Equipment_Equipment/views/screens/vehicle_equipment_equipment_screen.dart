...
// binding
part '../../bindings/vehicle_equipment_equipment_binding.dart';

// controller
part '../../controllers/vehicle_equipment_equipment_controller.dart';
...
class VehicleEquipmentEquipmentScreen
    extends GetView<VehicleEquipmentEquipmentController> {
  const VehicleEquipmentEquipmentScreen({Key? key}) : super(key: key);
                        ...
                        child: Row(
                          children: [
                            ...
                            Obx(() => controller.dataAvailable
                                ? Text(
                                    "${"EQUIPMENT".tr}:  ${controller.trx.rowcount}")
                                : Text("${"EQUIPMENT".tr}:  ")),
                          ],
                        ),
                      ),
