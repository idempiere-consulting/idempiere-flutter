...
class CRMContractCustomerLineController extends GetxController {
  ...
  Future<void> getContractLines() async {
    ...
    var url = Uri.parse(
        '$protocol://$ip/api/v1/models/C_ContractLine?\$filter= C_Contract_ID eq $lineId and AD_Client_ID eq ${GetStorage().read("clientid")}');
