...
// binding
part '../../bindings/crm_contract_line_binding.dart';

// controller
part '../../controllers/crm_contract_line_controller.dart';
...
class CRMContractCustomerLineScreen
    extends GetView<CRMContractCustomerLineController> {
  const CRMContractCustomerLineScreen({Key? key}) : super(key: key);
