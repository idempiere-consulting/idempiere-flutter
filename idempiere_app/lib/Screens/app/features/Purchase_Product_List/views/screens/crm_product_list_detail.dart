...
class PurchaseProductListDetail extends StatefulWidget {
  const PurchaseProductListDetail({Key? key}) : super(key: key);

  @override
  State<PurchaseProductListDetail> createState() =>
      _PurchaseProductListDetailState();
}

class _PurchaseProductListDetailState extends State<PurchaseProductListDetail>
