...
class EmployeeFilterResource extends StatefulWidget {
  const EmployeeFilterResource({Key? key}) : super(key: key);

  @override
  State<EmployeeFilterResource> createState() => _EmployeeFilterResourceState();
}

class _EmployeeFilterResourceState extends State<EmployeeFilterResource> {
  applyFilters() {
    if (valueFieldController.text != "") {
      Get.find<EmployeeResourceController>().valueFilter =
    ...
    if (nameFieldController.text != "") {
      Get.find<EmployeeResourceController>().nameFilter =
    ...
    if (licensePlateFieldController.text != "") {
      Get.find<EmployeeResourceController>().licensePlateFilter =
          " and contains(tolower(LIT_LicensePlate),'${licensePlateFieldController.text}')";
    } else {
      Get.find<EmployeeResourceController>().licensePlateFilter = "";
    }

    Get.find<EmployeeResourceController>().value.value =
        valueFieldController.text;
    Get.find<EmployeeResourceController>().name.value =
        nameFieldController.text;
    Get.find<EmployeeResourceController>().licensePlate.value =
        licensePlateFieldController.text;

    Get.find<EmployeeResourceController>().getResources();
    Get.back();
  }
