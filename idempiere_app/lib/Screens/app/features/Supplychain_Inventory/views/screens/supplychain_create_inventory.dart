...
class CreateSupplychainInventory extends StatefulWidget {
  const CreateSupplychainInventory({Key? key}) : super(key: key);

  @override
  State<CreateSupplychainInventory> createState() =>
      _CreateSupplychainInventoryState();
}

class _CreateSupplychainInventoryState
    extends State<CreateSupplychainInventory> {
