...
class EditTrainingCoursePresence extends StatefulWidget {
  const EditTrainingCoursePresence({Key? key}) : super(key: key);

  @override
  State<EditTrainingCoursePresence> createState() =>
      _EditTrainingCoursePresenceState();
}

class _EditTrainingCoursePresenceState
    extends State<EditTrainingCoursePresence> {
  editLead() async {
  ...
  deleteLead() async {
    ...
    if (response.statusCode == 200) {
      ...
      Get.snackbar(
        "Fatto!".tr,
        "Il record è stato cancellato".tr,
        icon: const Icon(
          Icons.delete,
          color: Colors.green,
        ),
        ...
        actions: [
          Padding(
            ...
            child: IconButton(
              onPressed: () {
                Get.defaultDialog(
                  title: "Eliminazione record".tr,
                  middleText: "Sicuro di voler eliminare il record?".tr,
                  backgroundColor: const Color.fromRGBO(38, 40, 55, 1),
                  //titleStyle: TextStyle(color: Colors.white),
                  //middleTextStyle: TextStyle(color: Colors.white),
                  textConfirm: "Elimina".tr,
                  textCancel: "Annulla".tr,
