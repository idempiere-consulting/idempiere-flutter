...
class CreateTrainingCoursePresence extends StatefulWidget {
  const CreateTrainingCoursePresence({Key? key}) : super(key: key);

  @override
  State<CreateTrainingCoursePresence> createState() =>
      _CreateTrainingCoursePresenceState();
}

class _CreateTrainingCoursePresenceState
