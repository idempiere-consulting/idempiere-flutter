...
class LocaleString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'en_US': {
          ...
          'Error!': 'Error!',
          'Account without authentication code': 'Account without authentication code',
          'Done!': 'Done!',
          'Records saved locally have been synchronized!': 'Records saved locally have been synchronized!',
          'LOGIN': 'LOGIN',
          'You are offline due to no internet connection, there will be limitations.': 'You are offline due to no internet connection, there will be limitations.',
          'You are offline due to no internet connection and not your last login is not recent enough.': 'You are offline due to no internet connection and not your last login is not recent enough.',
          'Protocol': 'Protocol',
          ...
          'Are you sure you want to complete the record?': 'Are you sure you want to complete the record?',
          'Contact: ': 'Contact: ',
          'Product: ': 'Product: ',
          'Expected Amount: ': 'Expected Amount: ',
          ...
          'Record not cancelled (is it your?)': 'Record not cancelled (is it your?)',
        ...
        'it_IT': {
          ...
          'Price': 'Prezzo',
          'Warehouse': 'Magazzino',
          'Create Entry': 'Segna Entrata',
          'Sign Entry': 'Timbra',
          'SET IDEMPIERE URL': 'IMPOSTA IDEMPIERE URL',
          'Syncing data with iDempiere...': 'Sincronizzazione di dati con iDempiere...',
          'Error!': 'Errore!',
          'Account without authentication code': 'Account senza Codice di Autenticazione valido',
          'Done!': 'Fatto!',
          'Records saved locally have been synchronized!': 'I record salvati localmente sono stati sincronizzati!',
          'LOGIN': 'ACCEDI',
          'You are offline due to no internet connection, there will be limitations.': 'Sei in offline a causa di mancata connessione Internet, saranno presenti delle limitazioni.',
          'You are offline due to no internet connection and not your last login is not recent enough.': 'Sei in offline a causa di mancata connessione Internet e non il tuo ultimo login non è abbastanza recente.',
          'Protocol ': 'Protocollo ',
          ...
          'Failed to load lead statuses': 'Fallito lo stato del caricamento dei lead',
          'Failed to load sales reps': 'Impossibile caricare i rappresentanti di vendita',
          ...
          'Are you sure to delete the record?': 'Sicuro di voler eliminare il record?',
          'Cancel': 'Annulla',
          ...
          'Are you sure you want to complete the record?': 'Sei sicuro di voler completare il record?',
          'Contact: ': 'Contatto: ',
          'Product: ': 'Prodotto: ',
          'Expected Amount: ': 'Importo Atteso: ',
          ...
          'Record not cancelled (is it your?)': 'Record non cancellato (è tuo?)',
          ...
          'Internet connection unavailable': 'Collegamento internet non disponibbile',
